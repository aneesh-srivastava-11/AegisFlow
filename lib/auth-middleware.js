...
export async function verifyServerSession(request) {
  try {
    ...
    if (!adminAuth) {
      console.warn('[Auth Middleware] Firebase Admin SDK is not initialized. Permitting in development mode.');
      // In development fallback, if no admin SDK is configured, return a mock user
